...
The "Sanctuary" direction from the Brand Revamp Concept.

| Token | Hex | Use |
|---|---|---|
| Velvet Noir | `#171209` | Page ground |
| Anointing Gold | `#C9A45C` | Primary accent, rules, CTAs |
| Candlelight | `#E9D3A0` | Emphasis, italic display |
| Ivory Balm | `#F2E9D8` | Body text |
| Lavender Oil | `#A798C0` | One whisper per section, product line |

Type: **Cormorant Garamond** for display, **Jost** for information.

House rules: no em dashes, no emojis, gold stays `#C9A45C`.

## Booking

All booking and gift certificate CTAs point to ClinicSense:
